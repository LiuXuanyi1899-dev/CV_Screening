"基于合成因子选股的机器学习策略"  
------------------------------
这是我在瑞银比赛中的作品，当时手法生疏，策略尚不完善，现在进行了一些优化   

总体思路：
通过logistic regression算法训练出的决策边界线来择时，与其他主流策略不一样，我的思路是进行价格回归的捕捉（非价值的回归）  
1.筛选股池：  
...
'''    
注：此策略是在聚宽的内置编译器上创作的，没有搭建回测系统，主要原因是zipline会经常出现各种问题。同时一些代码没有优化（比如应该用向量化运算代替for循环等），导致运算时间较长，后续可以考虑优化一下    
'''
